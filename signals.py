...
signal2 = amplitude * np.sin(2 * np.pi * random.randint(100,200) * timeSamples)
signal3 = amplitude * np.sin(2 * np.pi * random.randint(100,200) * timeSamples)
signal4 = amplitude * np.sin(2 * np.pi * random.randint(100,200) * timeSamples)
signal5 = amplitude * np.sin(2 * np.pi * random.randint(100,200) * timeSamples)
